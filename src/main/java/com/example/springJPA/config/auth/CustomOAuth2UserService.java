package com.example.springJPA.config.auth;


import com.example.springJPA.config.auth.dto.OAuthAttributes;
import com.example.springJPA.domain.posts.user.User;
import com.example.springJPA.domain.posts.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest)throws OAuth2AuthenticationException{
        ...
        String registraionId = userRequest.getClientRegistration().getRegistrationId();//소셜 서비스 구분
